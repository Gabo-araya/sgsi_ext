...
# Customization:
ln -s /usr/src/app/docker/zsh_dev/load-devcontainer-customs.zsh /root/.oh-my-zsh/custom/
ln -s /usr/src/app/docker/zsh_dev/custom/ /root/.oh-my-zsh/custom/project
# /root/.oh-my-zsh/custom/shared will be bind-mounted by compose.

# Theme:
ln -s /usr/src/app/docker/zsh_dev/robbyrussell-poetryenv.zsh-theme /root/.oh-my-zsh/custom/themes/
