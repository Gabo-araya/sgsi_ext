    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('int', 'integer'), ('time', 'time'), ('date', 'date'), ('json', 'json'), ('url', 'url'), ('host', 'host name'), ('ip_net', 'IP prefix/range'), ('host_list', 'host name list'), ('ip_net_list', 'IP prefix/range list'), ('bool', 'boolean'), ('str', 'text')], editable=False, max_length=255, verbose_name='kind')),
